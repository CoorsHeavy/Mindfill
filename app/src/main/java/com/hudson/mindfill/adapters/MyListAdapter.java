...
public class MyListAdapter extends BaseAdapter{
    ...
    public MyListAdapter(Activity mainActivity, ArrayList<Integer> prgmNameList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            JSONObject item = m_jArry.getJSONObject(prgmNameList.get(position));
        ...
        rowView = inflater.inflate(R.layout.listitem2, null);
