...
public class Schedule extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alertDialogBuilder.setMessage("Here you can map schedule treatments with your phones calender app. Tap an activity to add it to your calender. Do this as many times as you want. If you don't want to bother with the calender Mindfull can send you daily reminders to stay on top of your task.");
